...
| V3.0 Optimized  | 250+  | 95%      | Rubrics + multi-stage |
...
| Name             | Role                               |
|------------------|------------------------------------|
| Arsia Hullur     | AI/Prompt Engineering, Integration |
| Keon Correa      | Frontend Development, UI/UX        |
| Isha Swar        | Testing, Documentation             |
| Vaibhavi Borhade | Content                            |

# Smart Resource Allocation 🧠

**Live Demo:** https://solution-challenge-2026-a8a54.web.app  
**Video Demo:** https://youtu.be/your-video-id  
**GitHub Repo:** https://github.com/arsiahullur/solution-challenge-2026.git 
